"""Constants for pharma_news module."""
...
PG_PORT_DEFAULT = 4532

PHARMA_NEWS_PATH = Path(resource_filename('pharma_news', '/'))
REPO_ROOT = PHARMA_NEWS_PATH.parent
RESOURCES_DIR = PHARMA_NEWS_PATH / "resources"
DATA_DIR = RESOURCES_DIR / "data"
TMP_DIR = RESOURCES_DIR / "tmp"

# AZURE
AZURE_BLOB_STORAGE_CONTAINER = "atacana-blob-container"

# Google cloud service account
GOOGLE_SERVICE_ACCOUNT_DIR = REPO_ROOT / "service_account.json"

# Google Sheets IDs
MAPPER_SHEET_ID = {
    "indication_keywords": "1G_dxkjADV4-W0s1GZjXmwPafU-wNRsWnvt5zRDs9FPU"
}

# Redis.
REDIS_LIST_NAME_CONF = "indication_keywords"
